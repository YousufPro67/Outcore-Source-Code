...
local function addElement(self, element: Instance, tweenConfig: TweenInfo|nil)
	...
	end if OtherElements[element.ClassName] then
...
function BulkFade.CreateGroup(elements:ArrayList<Instance>, tweenConfig)
	local self = {};
	self.Faded = false;
	self.UiElements = {};
	self.AppearTweens = {};
	...
	for _, element in ipairs(elements) do
		addElement(self, element, tweenConfig or TweenInfo.new(.01));
	end
