...
return function (props)
    ...
    local countText = Computed(function()
        return props.Count:get() and Utils.toLocaleNumber(props.Count:get()) or ""
    end)
    ...
    return New "TextButton" {
        ...
        Size = Computed(function()
            return UDim2.new(
                0, (btnSize:get() or Vector2.zero).Y * props.IconSize:get() + textWidth:get() + padding:get() * (props.Count:get() and 3 or 2) - 1,
                1, 0
            )
        end),
