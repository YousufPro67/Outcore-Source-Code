...
return function (props)
    ...
    local countText = Computed(function()
        ...
        local fullText = props.Count:get() and Utils.toLocaleNumber(props.Count:get()) or ""
    ...
    local textWidth = Computed(function()
        local textSize = TextService:GetTextSize(countText:get(), btnSize:get().Y / 2, Enum.Font.GothamMedium, Vector2.new(math.huge, math.huge))
    ...
    return New "TextButton" {
        ...
        Size = Computed(function()
            return UDim2.new(
                0, (btnSize:get() or Vector2.zero).Y * props.IconSize:get() + textWidth:get() + padding:get() * 3 - 1,
                1, 0
            )
        end),
        ...
        [Children] = {
            ...
            New "TextLabel" {
                Visible = Computed(function() return (props.Count:get() ~= nil or props.Text:get() ~= nil) end),
                BackgroundTransparency = 1,
                LayoutOrder = 2,
