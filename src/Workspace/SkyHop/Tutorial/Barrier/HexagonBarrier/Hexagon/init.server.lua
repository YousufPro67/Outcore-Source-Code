...
local distanceFadeSettings = {
	...
	["TextureColor"] = Color3.fromRGB(255, 136, 1),
	["BackgroundColor"] = Color3.fromRGB(124, 64, 5),
...
local partsToAdd = {
	folder:WaitForChild("1", 20),
	folder:WaitForChild("2", 20),
	folder:WaitForChild("3", 20),
	folder:WaitForChild("4", 20),
	folder:WaitForChild("5", 20)
}
...
game:GetService("RunService").Heartbeat:Connect(function() -- using Heartbeat for Step() is visually smoother than PreRender
